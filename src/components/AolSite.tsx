...
.big-cta { display:inline-block; background:#cc0000; color:#ffffff; border:2px solid #ff4444; border-radius:4px; font-family:'Courier New',monospace; font-weight:bold; font-size:13px; letter-spacing:2px; padding:10px 32px; text-decoration:none; cursor:pointer; transition:background 0.15s; box-shadow:0 3px 10px rgba(180,0,0,0.3); }
.big-cta:hover { background:#ee1111; color:#ffffff; transform:translateY(-1px); box-shadow:0 4px 14px rgba(200,0,0,0.4); }
        ...
        <div data-section-content="services" style="display:none;">
          ...
          <div class="aol-panel">
            ...
            <div class="panel-body" style="text-align:center;">
              ...
              <a href="#" onclick="openWriteMail();return false;" class="big-cta">[ START A PROJECT ]</a>
        ...
        <div data-section-content="computing" style="display:none;">
          <div class="aol-panel">
            ...
            <div class="panel-body">
              ...
              <div style="text-align:center;margin-top:12px;"><a href="#" onclick="openWriteMail();return false;" class="big-cta">[ GET A QUOTE ]</a></div>
            </div>
          </div>
        </div>
        <div data-section-content="workplace" style="display:none;">
          <div class="aol-panel">
            ...
            <div class="panel-body">
              ...
              <div style="text-align:center;margin-top:12px;"><a href="#" onclick="openWriteMail();return false;" class="big-cta">[ START A PROJECT ]</a></div>
            </div>
          </div>
        </div>
...
<div id="screenname-overlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,128,0.75);z-index:9998;align-items:center;justify-content:center;"><div style="background:#c0c0c0;border-top:3px solid #fff;border-left:3px solid #fff;border-right:3px solid #404040;border-bottom:3px solid #404040;width:380px;max-width:96vw;font-family:Arial,sans-serif;"><div style="background:linear-gradient(to right,#000055,#1a6ecf);color:#fff;padding:3px 6px;display:flex;align-items:center;justify-content:space-between;"><div style="display:flex;align-items:center;gap:6px;"><span style="font-size:13px;">🐻</span><span id="auth-modal-title" style="font-size:11px;font-weight:bold;">Abearica Online — Sign In</span></div><span onclick="closeScreenNameModal()" class="title-bar-btn" style="cursor:pointer;">✕</span></div><div style="padding:16px 18px 12px;"><div style="text-align:center;margin-bottom:14px;"><div style="font-size:28px;">🐻</div><div style="font-family:'Lora',serif;font-size:15px;font-weight:bold;color:#000080;">Abearica Online</div><div style="font-size:10px;color:#666;margin-top:1px;font-style:italic;">Version 9.0 · Members get more</div></div><div style="display:flex;margin-bottom:12px;border-bottom:2px solid #808080;"><button id="tab-signin" onclick="switchAuthTab('signin')" style="flex:1;background:#fff;border:none;border-top:2px solid #808080;border-left:2px solid #808080;border-right:1px solid #808080;padding:4px;font-size:11px;font-weight:bold;color:#000080;cursor:pointer;">Sign In</button><button id="tab-signup" onclick="switchAuthTab('signup')" style="flex:1;background:#c0c0c0;border:none;border-top:2px solid #808080;border-left:1px solid #808080;border-right:2px solid #808080;padding:4px;font-size:11px;color:#444;cursor:pointer;">Create Account</button></div><div id="auth-signin-form"><div style="margin-bottom:8px;"><div style="font-size:11px;font-weight:bold;margin-bottom:2px;">Screen Name (Email):</div><input id="si-email" type="email" placeholder="you@email.com" style="width:100%;box-sizing:border-box;border-top:2px solid #404040;border-left:2px solid #404040;border-right:2px solid #fff;border-bottom:2px solid #fff;padding:4px 6px;font-size:11px;font-family:Arial;outline:none;"></div><div style="margin-bottom:12px;"><div style="font-size:11px;font-weight:bold;margin-bottom:2px;">Password:</div><input id="si-password" type="password" placeholder="••••••••" style="width:100%;box-sizing:border-box;border-top:2px solid #404040;border-left:2px solid #404040;border-right:2px solid #fff;border-bottom:2px solid #fff;padding:4px 6px;font-size:11px;font-family:Arial;outline:none;" onkeydown="if(event.key==='Enter')doSignIn()"></div><div id="si-status" style="font-size:10px;min-height:14px;margin-bottom:8px;color:#cc0000;"></div><button onclick="doSignIn()" style="width:100%;background:linear-gradient(to bottom,#000080,#000055);color:#FFD700;border:none;padding:6px;font-size:12px;font-weight:bold;cursor:pointer;letter-spacing:1px;">SIGN IN</button><div style="text-align:center;margin-top:8px;"><span style="font-size:10px;color:#444;">Forgot password? </span><span onclick="doForgotPassword()" style="font-size:10px;color:#000080;cursor:pointer;text-decoration:underline;">Reset it</span></div></div><div id="auth-signup-form" style="display:none;"><div style="margin-bottom:8px;"><div style="font-size:11px;font-weight:bold;margin-bottom:2px;">Screen Name:</div><input id="su-screenname" type="text" maxlength="20" placeholder="CoolBear99" style="width:100%;box-sizing:border-box;border-top:2px solid #404040;border-left:2px solid #404040;border-right:2px solid #fff;border-bottom:2px solid #fff;padding:4px 6px;font-size:11px;font-family:Arial;outline:none;"><div style="font-size:9px;color:#666;margin-top:2px;">3–20 chars, letters/numbers/underscores only</div></div><div style="margin-bottom:8px;"><div style="font-size:11px;font-weight:bold;margin-bottom:2px;">Email:</div><input id="su-email" type="email" placeholder="you@email.com" style="width:100%;box-sizing:border-box;border-top:2px solid #404040;border-left:2px solid #404040;border-right:2px solid #fff;border-bottom:2px solid #fff;padding:4px 6px;font-size:11px;font-family:Arial;outline:none;"></div><div style="margin-bottom:12px;"><div style="font-size:11px;font-weight:bold;margin-bottom:2px;">Password:</div><input id="su-password" type="password" placeholder="Min 6 characters" style="width:100%;box-sizing:border-box;border-top:2px solid #404040;border-left:2px solid #404040;border-right:2px solid #fff;border-bottom:2px solid #fff;padding:4px 6px;font-size:11px;font-family:Arial;outline:none;" onkeydown="if(event.key==='Enter')doSignUp()"></div><div id="su-status" style="font-size:10px;min-height:14px;margin-bottom:8px;color:#cc0000;"></div><button onclick="doSignUp()" style="width:100%;background:linear-gradient(to bottom,#000080,#000055);color:#FFD700;border:none;padding:6px;font-size:12px;font-weight:bold;cursor:pointer;letter-spacing:1px;">CREATE ACCOUNT</button><div style="font-size:9px;color:#666;text-align:center;margin-top:8px;">You'll receive a confirmation email.</div></div></div><div style="background:#d4d0c8;padding:5px 10px;display:flex;justify-content:flex-end;border-top:1px solid #fff;"><button onclick="closeScreenNameModal()" style="background:#c0c0c0;border-top:2px solid #fff;border-left:2px solid #fff;border-right:2px solid #404040;border-bottom:2px solid #404040;padding:3px 16px;font-size:11px;cursor:pointer;">Cancel</button></div></div></div>
